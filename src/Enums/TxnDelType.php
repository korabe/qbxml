 ...
 * @method static self PayrollLiabilityAdjustment()
 * @method static self PayrollPriorPayment()
 * @method static self PayrollYearToDateAdjustment()
 ...
 * @method static self TransferInventory()
